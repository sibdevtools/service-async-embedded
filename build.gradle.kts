...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                packaging = "jar"
                url = "https://github.com/simple-mocks/service-async-local"
                ...
                scm {
                    connection.set("scm:https://github.com/simple-mocks/service-async-local.git")
                    developerConnection.set("scm:git:ssh://github.com/sib-energy-craft")
                    url.set("https://github.com/simple-mocks/service-async-local")
                }
    ...
    repositories {
        ...
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/simple-mocks/service-async-local")
            credentials {
